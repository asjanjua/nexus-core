...
- **Last updated:** 2026-06-26 (v0.25.x — session #36 with Claude. Shared UI primitives extracted; Trust Drawer + Mode Indicator design-system fix shipped on the live `/dashboard/ceo` bridge — this is the pattern session #35 flagged as "do next.")
