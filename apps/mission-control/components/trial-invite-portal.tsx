/**
 * Pinavia trial invite portal client.
 *
 * Issue, copy, and revoke trial invite links. Fetch-only client page against
 * /api/admin/trial-invites. The server page and API both enforce the
 * platform-admin gate; nothing in this client component is trusted for access.
 *
