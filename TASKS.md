...
37. [~] Add public pilot-start intake page — `/start-pilot` now renders the kickoff input list, single primary workspace CTA, diagnostic/email secondary CTAs, product-room preview routes, and authority boundary. Local TypeScript/build/screenshot verification is complete; push, Render deploy, and live apex smoke are pending.
