...
38. [~] Align public landing CTAs to pilot start — homepage hero, header, money-map CTA, competitive-difference CTA, footer, and final pilot CTA now converge on `/start-pilot`; product-family cards point to live protected hubs. Local verification pending before push/deploy.
