...
**Initial Launch Final Pack V0.5 (2026-07-26):** Figma launch-lock board created at `https://www.figma.com/design/NcQ8F5a0hczwGwZua2gfun?node-id=125-2`. It records the launch truth for all pilot surfaces: NexusAI, Quorum, and Meridian can be shown against live/code-backed routes; Vantage and Nucleus are design-only until their routes are built.
...
34. [ ] Convert the V0.5 launch order into app changes — first staff invite smoke, then Meridian polish, then Quorum depth if selected, then Vantage/Nucleus route entries when a named pilot requires them.
