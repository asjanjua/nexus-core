...
| Item | Status | Source | Notes |
|---|---|---|---|
| Expert review P1 pass across existing Figma screens | in progress | `docs/UI_UX_EXPERT_REVIEW_2026-06-16.md` | Live-product portion done 2026-06-26: primary actions, Trust Drawer, Approval Consequence Preview, Now / Next strip, nav health badges, and passport drift warning are all built in the actual app, not just Figma. Figma screen parity for the same patterns is still open. |
