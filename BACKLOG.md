...
| Initial launch cockpit | done (Figma) | `docs/UI_V0_7_INITIAL_LAUNCH_COCKPIT.md`, Figma page `129:6` | Four screenshot-verified desktop frames consolidate final design sources, live demo routes, DNS blockers, acceptance checks, and next actions for colleague review before pilots. |
