...
| Reviewer as a real second seat (Clerk org + reviewer role + invite + identity-bound approvals) | live read path, behavior smoke pending | `docs/USER_STRATEGY_AND_PIVOTS.md` §Decisions 2026-07-07 | Migration 0035 and the authenticated management page are live; the legitimate empty-seat state rendered cleanly on 2026-07-15. Remaining production gate: two-account invite, acceptance, scorer, and bound-reviewer approval smoke. General workspace member roles remain a separate Phase 9 item. |
