...
| Reviewer as a real second seat (Clerk org + reviewer role + invite + identity-bound approvals) | local verified, deployment pending | `docs/USER_STRATEGY_AND_PIVOTS.md` §Decisions 2026-07-07 | Migration 0035, invite/resend/expiry, Clerk-identity acceptance, accepted-seat scorer gate, bound-reviewer approval enforcement, and management UI are built. Remaining production gate: apply migration 0035, deploy, and run the two-account authenticated smoke. General workspace member roles remain a separate Phase 9 item. |
...
| Pro waitlist for public launch (no checkout) | local verified, deployment pending | `docs/USER_STRATEGY_AND_PIVOTS.md` §Decisions 2026-07-09 | Migration 0037, authenticated waitlist API/page, and confirmation/ops email paths are built. Remaining: migration 0037, deploy, and the post-demo public-readiness handoff into the authenticated waitlist. |
| Pilot afterlife surface (run loop, shadow ROI capture, expand/stop record) | local verified, deployment pending | `docs/USER_STRATEGY_AND_PIVOTS.md` §Decisions 2026-07-07, `docs/SHADOW_MODE_ROI_PLAYBOOK.md` | Migration 0036, `/pilot/afterlife`, shadow-ROI capture, sponsor digest, and audited expand/hold/stop outcomes are built. Remaining: migration 0036, deploy/smoke, and propagate the outcome into pilot paperwork and the scorecard. |
