...
| Initial launch cockpit | done (Figma) | `docs/UI_V0_7_INITIAL_LAUNCH_COCKPIT.md`, Figma page `129:6`, frames `135:2`, `141:2`, `143:2`, `145:2`, `160:2` | Nine screenshot-verified desktop frames consolidate final design sources, live demo routes, DNS blockers, acceptance checks, next actions, the `/start-pilot` conversion route, refreshed `/product-brief`, `/readiness`, and `/diagnostic` paths, plus the code-backed two-screen Meridian Scope arc for colleague review before pilots. |
