...
| Pilot-start intake page | local verified, deployment pending | `/start-pilot`, V0.7 frame `135:2` | Redirect-only handoff replaced with a public Pinavia pilot-start page: required kickoff inputs, single primary workspace CTA, diagnostic/email secondary CTAs, product-room preview routes, and explicit human-authority boundary. Pending push, Render deploy, and live apex smoke. |
