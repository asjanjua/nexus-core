...
| Landing CTA alignment to pilot start | local verified, deployment pending | `/`, public shell, V0.7 frame `135:2` | Homepage hero, public header, money-map CTA, competitive-difference CTA, footer, and final pilot CTA now converge on `/start-pilot`; readiness remains the diagnostic secondary path. Product-family cards now link Meridian, Vantage, and Nucleus to their live protected hubs. Pending push, Render deploy, and live homepage smoke. |
