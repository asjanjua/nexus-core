...
| Governed evidence intake | [V0.7 Connector Evidence Intake `173:2`](https://www.figma.com/design/NcQ8F5a0hczwGwZua2gfun?node-id=173-2) | `/settings/connectors` | Final | `96fcd8f` live route-content and health smoke; server-side workspace guard added locally | Signed-out return-path smoke, then signed-in controlled-source install, source-policy save, and evidence-ingest smoke. |
