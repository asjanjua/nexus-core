...
- **Public proof:** The canonical `app.pinavia.io` smoke passed all 8 checks: health, home, HSTS, CSP, frame protection, protected redirect, allowed-origin CORS, and unknown-origin rejection.
