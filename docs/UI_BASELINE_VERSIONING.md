...
| Meridian Submission Room hub | `/meridian` |
...
| Vantage DD Copilot hub | `/vantage` |
...
| Nucleus Engagement Room hub | `/nucleus` |
| Nucleus methodology packs | `/nucleus/setup`, `/nucleus/methodologies`, `/nucleus/engagement-intake`, `/nucleus/evidence-room`, `/nucleus/deliverable-builder`, `/nucleus/reviewer-console`, `/nucleus/client-portal`, `/nucleus/publish` |
